...
bool PaymentServer::ipcSendCommandLine()
{
    ...
    {
        if (!args[i].startsWith(MONETA_IPC_PREFIX, Qt::CaseInsensitive))
            continue;
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click moneta: links)
...
{
    // clicking on moneta: URLs creates FileOpen events on the Mac:
